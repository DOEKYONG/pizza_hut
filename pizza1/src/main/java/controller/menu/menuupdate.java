...
public class menuupdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				String menucontent = request.getParameter("menucontent2");
				...
				Menu menu = new Menu( menunum , menuname, menucontent, menuprice, menuimg,cnum);
				boolean result =  MenuDao.getmemberDao().menuupdate(menu);
